                    ...
                    mapLibreMap.addOnCameraMoveListener(() -> {
                        ...
                        ListFragment.lameStatic.queryArgs.setLocationBounds(
                                new com.google.android.gms.maps.model.LatLngBounds(
                                    new com.google.android.gms.maps.model.LatLng(curScreen.latitudeSouth, curScreen.longitudeWest),
                                    new com.google.android.gms.maps.model.LatLng(curScreen.latitudeNorth, curScreen.longitudeEast)
                                )
                        );
                        if (null != v) {
